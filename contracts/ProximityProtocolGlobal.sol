...
// OpenZeppelin Contracts (last updated v4.5.0) (token/ERC1155/presets/ProximityProtocolGlobal.sol)
    ...
    UUPSUpgradeable
{
    ...
    function pause() public virtual {
        require(
            ...
            "ProximityProtocolGlobal: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ProximityProtocolGlobal: must have pauser role to unpause"
        );
        _unpause();
    }
